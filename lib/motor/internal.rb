...
module Motor
  ...
  class Runner
    ...
    def run(*args, &block) # rubocop:disable Metrics/MethodLength
  ...
  def self.filetype(file, type: nil, default: nil)
    type ||= file ? ::File.extname(file)[1..] : nil
    type ? type.to_s.downcase.to_sym : default
  end
end
